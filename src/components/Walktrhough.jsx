  ...
  return (
    <section className='w-full flex justify-center gap-32 mt-32 bg-single-wave-pattern'>
      ...
      <div className="cardsContainer flex justify-center">
        ...
        <div className="introCard bg-gradient-to-b from-blue-500 to-pink-400" id="card2">
          <div className="illustrationsBG"></div>
          <Image
        ...
        <div className="introCard bg-gradient-to-b from-blue-500 to-pink-400 relative left-10 top-30 rotate-3 z-2" id="card3">
          <div className="illustrationsBG"></div>
          <Image
            className="cardsIllustration"
